...
describe('Chat', () => {
    ...
    it('maps say() method to BelendBot instance', () => {
    ...
    it('maps sendTextMessage() method to BelendBot instance', () => {
    ...
    it('maps sendButtonTemplate() method to BelendBot instance', () => {
        const text = 'hello world';
    ...
    it('maps sendGenericTemplate() method to BelendBot instance', () => {
    ...
    it('maps sendTemplate() method to BelendBot instance', () => {
    ...
    it('maps sendAttachment() method to BelendBot instance', () => {
        const type = 'video';
    ...
    it('maps sendAction() method to BelendBot instance', () => {
    ...
    it('maps sendMessage() method to BelendBot instance', () => {
    ...
    it('maps sendRequest() method to BelendBot instance', () => {
    ...
    it('maps sendTypingIndicator() method to BelendBot instance', () => {
    ...
    it('maps getUserProfile() method to BelendBot instance', () => {
        const spy = sinon.spy(bot, 'getUserProfile');
        chat.getUserProfile();
        expect(spy.calledWith(chat.userId)).to.equal(true);
    });

    it('maps conversation() method to BelendBot instance', () => {
        const factory = () => {};
    ...
    it('maps runWit() method to BelendBot instance', () => {
        const text = "hello world!";
        const spy = sinon.spy(bot, 'runWit');
        chat.runWit(text);
        expect(spy.calledWith(chat.userId, text)).to.equal(true);
    });
});
